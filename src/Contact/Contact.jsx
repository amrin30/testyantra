...
import Image1 from '../Image/united-states.jpg'
import Image2 from '../Image/canada.jpg'
import Image3 from '../Image/unitedKingdom.jpg'
import Image4 from '../Image/Ireland.jpg'
import Image5 from '../Image/Netherland.jpg'
import Image6 from '../Image/india.jpg'
      ...
      <div className={StyleSkills.cont2}>
        <form action="" className={StyleSkills.form}>
          <div className={StyleSkills.main2}>
            ...
            <button className={StyleSkills.btn} type='submit'>Submit</button>
          </div>
        </form>
      </div>
      {/* -----------contact--------------------------------- */}
