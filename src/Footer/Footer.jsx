...
import Image17 from '../Image/partnerlogo2.svg'
import Ani from './Ani';
const Footer = () => {
    return (
        <div className={Style2.Main1}>
            ...
            <div className={Style2.aline} ></div>
            <footer className={Style2.foot}>
                <div className={Style2.cont9}>
                    <div className={Style2.head4}>
                        <div className={Style2.main9}>
                            <div className={Style2.sub}>
                                <h2 className={Style2.subs}>Subcribe to our Newsletter</h2>
                                <br />
                                <div className={Style2.alli}>
                    ...
                    <div className={Style2.main10}>
                        ...
                        <div className={Style2.copy}>
                        <p className={Style2.para3}>Copyright ©2024 Test Yantra Global. All rights reserved</p>
                        </div>
        </div>
    )
}
